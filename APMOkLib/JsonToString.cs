using APMOkLib.JsonConverters;
using APMOkLib.JsonConverters.DateTimeConverters;
using System;
using System.Text;
...
public abstract class JsonToString : IFormattable
{
    ...
    public static string MakeString(object ob, string format, IFormatProvider? formatProvider)
    {
        ...
        if (formatProvider is not null)
            options.Converters.Add(new JsonDateTimeConverter<StringDateTimeFormat>(formatProvider));
